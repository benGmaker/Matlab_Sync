...
if plt==1  % no plot required
    ...
    set(10,'position',[500 100 700 550])
    set(10,'paperposition',[0 0 5 6.8])

    subplot(411);
    text(tt(1)+tt(8)/200,max(j)/5,'t_0','interpreter','tex');
    text(tt(2)+tt(8)/200,max(j)/5,'t_1','interpreter','tex');
    text(tt(3)          ,max(j)/5,'t_2','interpreter','tex');
    text(tt(4)          ,max(j)/5,'t_3','interpreter','tex');
    text(tt(5)          ,max(j)/5,'t_4','interpreter','tex');
    text(tt(6)          ,max(j)/5,'t_5','interpreter','tex');
    text(tt(7)+tt(8)/200,max(j)/5,'t_6','interpreter','tex');
    text(tt(8)+tt(8)/200,max(j)/5,'t_7','interpreter','tex');
end
