...
% Inspect matrices of homogenous transformations representing positions x^{i-1}_{i} and
...
% x^0_i and orientations R^0_i  of the link coordinate frames 
% oixiyizi (i=1,2,3) relative to the coordinate frame o0x0y0z0 of the base
...
% Create 
% the linear  velocity Jacobian Jv and 
% the angular velocity Jacobian Jomega

o_0_0=[0;0;0]; %origin 0 
z_0_0=[0;0;1]; %z-direction 0 
