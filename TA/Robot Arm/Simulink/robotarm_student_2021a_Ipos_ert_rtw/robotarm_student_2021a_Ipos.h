...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  /* Expression: [0                    0                    0      1696465377.1493;0  0  0  0;0  0  0  0]
  ...
  real_T DiscreteTimeIntegrator_gainva_j;
                           ...
                           */
  real_T Constant_Value_f;             /* Expression: 0.05
  ...
  real_T UnitDelay_InitialCondition;   /* Expression: 0
                                        ...
                                        */
  real_T set_robot_calibration_r_Value;/* Expression: 1.7269
                                        * Referenced by: '<S14>/set_robot_calibration_r'
                                        */
  real_T set_robot_calibration_x_Value;/* Expression: 0.64
                                        * Referenced by: '<S14>/set_robot_calibration_x'
                                        */
  real_T set_robot_calibration_z_Value;/* Expression: -0.48613
