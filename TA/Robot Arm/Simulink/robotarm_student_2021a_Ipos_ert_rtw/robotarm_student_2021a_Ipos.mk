...
## Generated on : Wed Mar 20 12:31:58 2024
...
PRODUCT_NAME              = robotarm_student_2021a_Ipos
MAKEFILE                  = robotarm_student_2021a_Ipos.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/ghattum/robotArm/robotarm_student/Simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/robotarm_student_2021a_Ipos.elf
...
DEFINES_STANDARD = -DMODEL=robotarm_student_2021a_Ipos -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/Robot1_12/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Robot1_12/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Robot1_12/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


robotarm_student_2021a_Ipos.c.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/robotarm_student_2021a_Ipos.c
	$(CC) $(CFLAGS) -o "$@" "$<"


robotarm_student_2021a_Ipos_data.c.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/robotarm_student_2021a_Ipos_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/robotarm_student_2021a_Ipos_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
getSystemClockTimeval_wrapper.c.o : $(START_DIR)/getSystemClockTimeval_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
