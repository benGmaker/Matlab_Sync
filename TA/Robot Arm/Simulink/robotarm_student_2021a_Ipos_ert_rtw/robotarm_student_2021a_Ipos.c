 ...
 * C source code generated on : Fri Mar 22 08:41:14 2024
 *
  ...
  if (robotarm_student_2021a_Ipos_DW.is_active_c16_robotarm_student_ == 0U) {
    ...
    switch (robotarm_student_2021a_Ipos_DW.is_c16_robotarm_student_2021a_I) {
     ...
     case robotar_IN_EnableRunAndSafety_i:
      ...
      } else if (robotarm_student_2021a_Ipos_B.Gain1 < -0.6) {
        robotarm_student_2021a_Ipos_DW.is_c16_robotarm_student_2021a_I =
...
void robotarm_student_2021a_Ipos_initialize(void)
{
  ...
  /* External mode info */
  robotarm_student_2021a_Ipos_M->Sizes.checksums[0] = (1113803768U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[1] = (2281775195U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[2] = (529783755U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[3] = (3012391756U);
