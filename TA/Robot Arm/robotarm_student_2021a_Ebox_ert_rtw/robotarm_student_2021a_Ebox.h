...
#ifndef robotarm_student_2021a_Ebox_h_
#define robotarm_student_2021a_Ebox_h_
...
typedef struct {
  ...
  real_T homeControllerEnabled_l;      /* '<S23>/Supervisor' */
  real_T resetEnc_o;                   /* '<S23>/Supervisor' */
  real_T homingBusy_i;                 /* '<S23>/Supervisor' */
  real_T airBagEnabled;                /* '<S23>/Supervisor' */
  real_T airBagRef;                    /* '<S23>/Supervisor' */
  real_T controlEnabled;               /* '<S23>/Supervisor' */
  real_T Ready_e;                      /* '<S23>/Supervisor' */
  real_T StopSim_e;                    /* '<S23>/Supervisor' */
  real_T y;                            /* '<S23>/Angle2Z' */
  real_T jogSpeed_a;                   /* '<S22>/Supervisor' */
  real_T toPoint_a;                    /* '<S22>/Supervisor' */
  real_T homeControllerEnabled_j;      /* '<S22>/Supervisor' */
  real_T resetEnc_c;                   /* '<S22>/Supervisor' */
  real_T homingBusy_o;                 /* '<S22>/Supervisor' */
  real_T airBagEnabled_c;              /* '<S22>/Supervisor' */
  real_T airBagRef_k;                  /* '<S22>/Supervisor' */
  real_T controlEnabled_h;             /* '<S22>/Supervisor' */
  real_T Ready_j;                      /* '<S22>/Supervisor' */
  real_T StopSim_l;                    /* '<S22>/Supervisor' */
  real_T jogSpeed_b;                   /* '<S21>/Supervisor' */
  real_T toPoint_o;                    /* '<S21>/Supervisor' */
  real_T homeControllerEnabled_n;      /* '<S21>/Supervisor' */
  real_T resetEnc_k;                   /* '<S21>/Supervisor' */
  real_T homingBusy_m;                 /* '<S21>/Supervisor' */
  real_T airBagEnabled_m;              /* '<S21>/Supervisor' */
  real_T airBagRef_i;                  /* '<S21>/Supervisor' */
  real_T controlEnabled_c;             /* '<S21>/Supervisor' */
  real_T Ready_d;                      /* '<S21>/Supervisor' */
  real_T StopSim_g;                    /* '<S21>/Supervisor' */
  real_T y_f;                          /* '<S21>/Angle2Z' */
  ...
  real_T Dctintegrator_j;              /* '<S5>/Dctintegrator' */
  real_T Dctleadlag_fi;                /* '<S5>/Dctleadlag' */
  real_T Dct1lowpass_az;               /* '<S5>/Dct1lowpass' */
  real_T SignalConversion1;            /* '<S1>/Signal Conversion1' */
  real_T Gain1_n5;                     /* '<S7>/Gain1' */
  real_T Dctleadlag_h;                 /* '<S7>/Dctleadlag' */
  real_T Dct1lowpass_m;                /* '<S7>/Dct1lowpass' */
  real_T SignalConversion;             /* '<S1>/Signal Conversion' */
  real_T Gain_d;                       /* '<S8>/Gain' */
  real_T Dctleadlag_l;                 /* '<S8>/Dctleadlag' */
  real_T Dct1lowpass_mi;               /* '<S8>/Dct1lowpass' */
  ...
  real_T Sum2_m;                       /* '<S22>/Sum2' */
  real_T Sum2_o;                       /* '<S23>/Sum2' */
  real_T fx1_tmp;
  real_T fy2_tmp;
  real_T d12_tmp;
  real_T b_a_tmp;
  real_T b_a_tmp_k;
  real_T LimitAcceleration_a;          /* '<S33>/Limit Acceleration' */
  real_T TSamp;                        /* '<S55>/TSamp' */
  real_T TSamp_m;                      /* '<S45>/TSamp' */
  real_T TSamp_k;                      /* '<S36>/TSamp' */
  real_T LimitAcceleration;            /* '<S49>/Limit Acceleration' */
  real_T LimitAcceleration_c;          /* '<S39>/Limit Acceleration' */
  real_T Add1_c;                       /* '<S13>/Add1' */
...
typedef struct {
  ...
  real_T PrevY;                        /* '<S49>/Limit Speed' */
  real_T PrevY_m;                      /* '<S49>/Limit Acceleration' */
  real_T PrevY_h;                      /* '<S39>/Limit Speed' */
  real_T PrevY_mh;                     /* '<S39>/Limit Acceleration' */
  real_T PrevY_d;                      /* '<S33>/Limit Speed' */
  real_T PrevY_n;                      /* '<S33>/Limit Acceleration' */
  real_T currentcarPos;                /* '<S23>/Supervisor' */
  real_T currentcarPos_o;              /* '<S22>/Supervisor' */
  real_T currentcarPos_e;              /* '<S21>/Supervisor' */
  ...
  real_T Dctintegrator_RWORK_d[2];     /* '<S5>/Dctintegrator' */
  real_T Dctleadlag_RWORK_k[2];        /* '<S5>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_a[2];       /* '<S5>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_n[2];        /* '<S7>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_d[2];       /* '<S7>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_d[2];        /* '<S8>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_az[2];      /* '<S8>/Dct1lowpass' */
  ...
  int32_T sfEvent_c;                   /* '<S23>/Supervisor' */
  int32_T sfEvent_o;                   /* '<S23>/Angle2Z' */
  int32_T sfEvent_d;                   /* '<S22>/Supervisor' */
  int32_T sfEvent_m;                   /* '<S21>/Supervisor' */
  int32_T sfEvent_n;                   /* '<S21>/Angle2Z' */
  ...
  uint16_T temporalCounter_i1_b;       /* '<S23>/Supervisor' */
  uint16_T temporalCounter_i1_j;       /* '<S22>/Supervisor' */
  uint16_T temporalCounter_i1_a;       /* '<S21>/Supervisor' */
  ...
  boolean_T doneDoubleBufferReInit;    /* '<S23>/Angle2Z' */
  boolean_T doneDoubleBufferReInit_j;  /* '<S21>/Angle2Z' */
  boolean_T doneDoubleBufferReInit_g;  /* '<S1>/Stateflow ' */
...
struct P_robotarm_student_2021a_Ebox_T_ {
  ...
  real_T DiscreteDerivative_ICPrevScal_p;
                               ...
                               */
  real_T DiscreteDerivative_ICPrevSca_pr;
  ...
  real_T Dctleadlag_P3_Size_d[2];    /* Computed Parameter: Dctleadlag_P3_Size_d
                                      * Referenced by: '<S7>/Dctleadlag'
                                      */
  real_T Dctleadlag_P3_p;              /* Expression: 0.001
                                        * Referenced by: '<S7>/Dctleadlag'
                                        */
  ...
  real_T SineWave1_Bias;               /* Expression: 0
                                        * Referenced by: '<S1>/Sine Wave1'
                                        */
  real_T SineWave1_Freq;               /* Expression: 0.1
                                        * Referenced by: '<S1>/Sine Wave1'
                                        */
  ...
  real_T Dctleadlag_P1_Size_n[2];    /* Computed Parameter: Dctleadlag_P1_Size_n
                                      ...
                                      */
  real_T Dctleadlag_P1_n;              /* Expression: f_num
                                        * Referenced by: '<S8>/Dctleadlag'
                                        */
  real_T Dctleadlag_P2_Size_h[2];    /* Computed Parameter: Dctleadlag_P2_Size_h
                                      * Referenced by: '<S8>/Dctleadlag'
                                      */
  real_T Dctleadlag_P2_j;              /* Expression: f_den
                                        * Referenced by: '<S8>/Dctleadlag'
                                        */
  real_T Dctleadlag_P3_Size_b[2];    /* Computed Parameter: Dctleadlag_P3_Size_b
                                      * Referenced by: '<S8>/Dctleadlag'
                                      */
  real_T Dctleadlag_P3_n;              /* Expression: 0.001
                                        * Referenced by: '<S8>/Dctleadlag'
                                        */
  ...
  real_T Dct1lowpass_P2_Size_d[2];  /* Computed Parameter: Dct1lowpass_P2_Size_d
                                     * Referenced by: '<S8>/Dct1lowpass'
                                     */
  real_T Dct1lowpass_P2_m;             /* Expression: 0.001
                                        * Referenced by: '<S8>/Dct1lowpass'
                                        */
  ...
  real_T Dct1lowpass_P2_d;             /* Expression: 0.001
                                        * Referenced by: '<S4>/Dct1lowpass'
                                        */
  real_T Dctleadlag_P1_Size_i[2];    /* Computed Parameter: Dctleadlag_P1_Size_i
  ...
  real_T Dctleadlag_P2_Size_m[2];    /* Computed Parameter: Dctleadlag_P2_Size_m
                                      * Referenced by: '<S4>/Dctleadlag'
                                      */
  real_T Dctleadlag_P2_f1;             /* Expression: f_den
                                        * Referenced by: '<S4>/Dctleadlag'
                                        */
  real_T Dctleadlag_P3_Size_h[2];    /* Computed Parameter: Dctleadlag_P3_Size_h
                                      * Referenced by: '<S4>/Dctleadlag'
                                      */
  real_T Dctleadlag_P3_j;              /* Expression: 0.001
                                        * Referenced by: '<S4>/Dctleadlag'
                                        */
  ...
  real_T FeedfowardRV_Value;           /* Expression: 0
                                        ...
                                        */
  real_T Conveyorspeedmms_Value;       /* Expression: 5
  ...
  real_T Dctleadlag_P3_m;              /* Expression: 0.001
                                        * Referenced by: '<S30>/Dctleadlag'
                                        */
  real_T Dct1lowpass_P1_Size_fg[2];/* Computed Parameter: Dct1lowpass_P1_Size_fg
  ...
  real_T Dct1lowpass_P2_l;             /* Expression: 0.001
                                        * Referenced by: '<S30>/Dct1lowpass'
                                        */
  real_T Gain_Gain_j;                  /* Expression: 25
                                        * Referenced by: '<S31>/Gain'
                                        */
  real_T Dctleadlag_P1_Size_nt[2];  /* Computed Parameter: Dctleadlag_P1_Size_nt
  ...
  real_T Dctleadlag_P2_o;              /* Expression: f_den
                                        * Referenced by: '<S31>/Dctleadlag'
                                        */
  real_T Dctleadlag_P3_Size_dx[2];  /* Computed Parameter: Dctleadlag_P3_Size_dx
                                     * Referenced by: '<S31>/Dctleadlag'
                                     */
  ...
  real_T Dctleadlag_P3_f;              /* Expression: 0.001
                                        * Referenced by: '<S37>/Dctleadlag'
                                        */
  real_T Dct1lowpass_P1_Size_mb[2];/* Computed Parameter: Dct1lowpass_P1_Size_mb
  ...
  real_T Dctleadlag_P1_Size_f[2];    /* Computed Parameter: Dctleadlag_P1_Size_f
                                      ...
                                      */
  real_T Dctleadlag_P1_hw;             /* Expression: f_num
                                        * Referenced by: '<S47>/Dctleadlag'
                                        */
  real_T Dctleadlag_P2_Size_dd[2];  /* Computed Parameter: Dctleadlag_P2_Size_dd
                                     * Referenced by: '<S47>/Dctleadlag'
                                     */
  ...
  real_T DiscreteTimeIntegrator_IC_f;  /* Expression: 0
                                        * Referenced by: '<S24>/Discrete-Time Integrator'
                                        */
  real_T Gain1_Gain_pj;                /* Expression: 10*2.5/500
  ...
  real_T LimitAcceleration_IC_f;       /* Expression: 0
                                        * Referenced by: '<S39>/Limit Acceleration'
                                        */
  real_T LimitSpeed_RisingLim_m;       /* Expression: 0.6
                                        * Referenced by: '<S33>/Limit Speed'
                                        */
  real_T LimitSpeed_FallingLim_jk;     /* Expression: -0.6
                                        * Referenced by: '<S33>/Limit Speed'
                                        */
  real_T LimitSpeed_IC_h;              /* Expression: 0
                                        * Referenced by: '<S33>/Limit Speed'
                                        */
  real_T TSamp_WtEt_a;                 /* Computed Parameter: TSamp_WtEt_a
                                        * Referenced by: '<S36>/TSamp'
                                        */
  real_T LimitAcceleration_RisingLim_a;/* Expression: 0.8
                                        * Referenced by: '<S33>/Limit Acceleration'
                                        */
  real_T LimitAcceleration_FallingLim_o;/* Expression: -0.8
                                         * Referenced by: '<S33>/Limit Acceleration'
                                         */
  real_T LimitAcceleration_IC_a;       /* Expression: 0
                                        * Referenced by: '<S33>/Limit Acceleration'
                                        */
  ...
  real_T ResetEncoderConv_P2;          /* Expression: chan_id
                                        * Referenced by: '<S24>/Reset EncoderConv'
                                        */
  real_T Gain_Gain_jz;                 /* Expression: 1/100
  ...
  char_T LEDRing_Y0[256];              /* Computed Parameter: LEDRing_Y0
                                        ...
                                        */
  char_T Colorsetwithstringblackorwhite_[256];/* Expression: 'black'
                                               * Referenced by: '<S1>/Color; set with string; black or white'
                                               */
  char_T Colorspecifiedin6hexdigitsrrggb[256];/* Expression: '0072bd'
                                               * Referenced by: '<S1>/Color; specified in 6 hex digits, rrggbb'
                                               */
  char_T StringConstant3_String[256];  /* Expression: 'color '
                                        * Referenced by: '<S29>/String Constant3'
                                        */
  char_T StringConstant4_String[256];  /* Expression: 'white'
                                        * Referenced by: '<S27>/String Constant4'
                                        */
  char_T StringConstant1_String[256];  /* Expression: 'black'
                                        * Referenced by: '<S27>/String Constant1'
                                        */
  char_T ReadyGreen_String[256];       /* Expression: '0000FF00'
                                        * Referenced by: '<S13>/Ready Green'
                                        */
  char_T AirbagRed_String[256];        /* Expression: '00FF0000'
                                        * Referenced by: '<S13>/Airbag Red'
                                        */
  char_T HomingOrange_String[256];     /* Expression: '00FF3900'
...
struct tag_RTM_robotarm_student_2021a_Ebox_T {
  ...
  struct {
    ...
    SimStruct childSFunctions[36];
    SimStruct *childSFunctionPtrs[36];
    struct _ssBlkInfo2 blkInfo2[36];
    struct _ssSFcnModelMethods2 methods2[36];
    struct _ssSFcnModelMethods3 methods3[36];
    struct _ssSFcnModelMethods4 methods4[36];
    struct _ssStatesInfo2 statesInfo2[36];
    ssPeriodicStatesInfo periodicStatesInfo[36];
    struct _ssPortInfo2 inputOutputPortInfo2[36];
    struct {
      time_T sfcnPeriod[1];
      time_T sfcnOffset[1];
      int_T sfcnTsMap[1];
 ...
 */
#endif                                 /* robotarm_student_2021a_Ebox_h_ */
